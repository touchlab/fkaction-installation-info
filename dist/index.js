...
function mergeBranch() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, node_fetch_1.default)(`https://api.touchlab.dev/gh/installationInfo?faktorySecretKey=${faktorySecretKey}`)
            .then(response => {
            if (!response.ok) {
            ...
            .then((data) => core.setOutput('buildBranch', data.buildBranch))
            .catch(error => {
            if (error instanceof Error) {
                core.setFailed(error.message);
            }
